 ...
 * "This work uses content from the Sansar Knowledge Base. � 2017 Linden Research, Inc. Licensed under the Creative Commons Attribution 4.0 International License (license summary available at https://creativecommons.org/licenses/by/4.0/ and complete license terms available at https://creativecommons.org/licenses/by/4.0/legalcode)."
    ...
    Simple Timer that counts up 1 every second. Code provided by OldVamp, modified by SurrealProducts.

    Drag this script into a Mesh Object in Editor. Save and Build Scene. In-world when you hover your mouse over the Object seconds counter will go up.
...
public class DisplayText : SceneObjectScript
{
    ...
    //float tick = 1.0f / 8.0f; //set updates per second, max 90
    float tick = 1;
    int Seconds = 0;
    string SecondsText = "";
    ...
    public override void Init()
    {
        ...
        Timer.Create(TimeSpan.FromSeconds(tick), TimeSpan.FromSeconds(tick), TimerTick);
        ...
        SetTextHere.SetPrompt(SecondsText);
        }
